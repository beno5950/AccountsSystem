...
namespace AccountSystem.BL.Journals
{
    class cls_Journals
    {
        ...
        public void Journal_Hdr_Add(int jno,DateTime jdate,int jtype,string jnote,int jpost,double tdeb,double tcred,double bal,int uadd,DateTime adate,int cno,double currexch,int ptype)
        {
            DAL.cn con = new DAL.cn();
            con.openConnection();
