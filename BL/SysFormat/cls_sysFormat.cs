...
namespace AccountSystem.BL.SysFormat
{
    class cls_sysFormat
    {
        ...
        #region Company
        public void AddCompany(string aname,string ename,string apos,string epos,string tel,string fax,string email,string website,byte[] img)
        {
        ...
        public DataTable Get_all_Cdata()
        {
            DAL.cn con = new DAL.cn();
            con.openConnection();
