...
namespace AccountSystem.BL.Accounts
{
    class cls_accounts
    {
        DataTable dt;
        ...
        public DataTable Account_Test(int accno)
        {
            ...
            para[0] = new SqlParameter("@Acc_No", SqlDbType.Int);
            para[0].Value = accno;
            dt = con.selectData("Accoun_Test", para);
            con.closeConnection();
            return dt;
        ...
        public DataTable Search_In_Account(string txt)
        {
            DAL.cn con = new DAL.cn();
            con.openConnection();
            dt = new DataTable();
        ...
        public DataTable get_trail_balance(double currexch,DateTime fdate,DateTime tdate)
        {
            DAL.cn con = new DAL.cn();
            con.openConnection();
            dt = new DataTable();
            SqlParameter[] para = new SqlParameter[3];
            para[0] = new SqlParameter("@currexch",SqlDbType.Money);
            para[0].Value = currexch;
            para[1] = new SqlParameter("@fdate", SqlDbType.DateTime);
            para[1].Value = fdate;
            para[2] = new SqlParameter("@tdate", SqlDbType.DateTime );
            para[2].Value = tdate;
            dt = con.selectData("trail_balance", para);
            con.closeConnection();
            return dt;

        }

        public DataTable get_final_account(double currexch, DateTime fdate, DateTime tdate,int rtype)
        {
            DAL.cn con = new DAL.cn();
            con.openConnection();
            dt = new DataTable();
            ...
            para[2] = new SqlParameter("@tdate", SqlDbType.DateTime);
            para[2].Value = tdate;
            para[3] = new SqlParameter("@rtype", SqlDbType.Int);
            para[3].Value = rtype;
            dt = con.selectData("final_accounts", para);
            con.closeConnection();
            return dt;
